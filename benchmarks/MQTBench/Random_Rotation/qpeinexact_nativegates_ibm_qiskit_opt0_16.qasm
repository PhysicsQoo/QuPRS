...
rz(pi/2) q[11];
rz(pi/2) q[12];
rx(1.7326075145176807) q[8];
rx(pi/2) q[12];
rz(pi/2) q[12];
rz(pi/2) q[13];
rx(pi/2) q[13];
rz(4.526254374645121) q[12];
rz(pi/2) q[13];
rz(pi/2) q[14];
rx(pi/2) q[14];
rz(pi/2) q[14];
