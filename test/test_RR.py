...
def test_HH():
    ...
    assert circuit1.get_reduction_counts() == {
        "total": 2,
        "Elim": 1,
        "HH": 1,
        "omega": 0,
    }, "circuit1_counts: {}".format(circuit1.get_reduction_counts())
    assert circuit1.get_reduction_hitrate() == 1, "circuit1_hitrate: {}".format(
        circuit1.get_reduction_hitrate()
    )
